...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bold
```

A live public deployment of this template is available at [https://bold.templates.workers.dev](https://bold.templates.workers.dev)
